/* Generated by re2c 3.0 on Fri Apr  8 00:26:06 2022 */
#![allow(unused_braces)]
        ...
        
        {
            ...
            'yyl: loop {
                ...
                return emit_token!(self, StringLiteral);
                    ...
                    137 => { return emit_token!(self, SingleLineComment); }
                    138 => {
                        yych = unsafe {if self.cursor<self.s.len(){*self.s.get_unchecked(self.cursor)}else{0}};
                        match yych {
                            0x30 ..= 0x39 |
                    ...
                    693 => { return emit_token!(self, MultiLineComment); }
                    694 => {
                        yych = unsafe {if self.cursor<self.s.len(){*self.s.get_unchecked(self.cursor)}else{0}};
                        match yych {
                            0x80 ..= 0xA7 |
                    ...
                    697 => { return emit_token!(self, NullLiteral); }
                    698 => {
                        yyaccept = 6;
                        self.mark = self.cursor;
                        yych = unsafe {if self.cursor<self.s.len(){*self.s.get_unchecked(self.cursor)}else{0}};
                    ...
                    699 => { return emit_token!(self, BooleanLiteral); }
                    700 => {
                        yych = unsafe {if self.cursor<self.s.len(){*self.s.get_unchecked(self.cursor)}else{0}};
                        match yych {
                            0x30 ..= 0x39 |
